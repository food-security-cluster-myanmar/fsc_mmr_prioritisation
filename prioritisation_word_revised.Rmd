...
fs_pin %>%  
  ...
  select(group, conflict_score_2021, `%_fatalities_2021`, vulnerability_2019, ppl_km2, 
         townships, `%_total_population`) %>% 
  mutate_at(vars(conflict_score_2021, vulnerability_2019), ~round(.x, digits = 3)) %>%
...
Groups A1 and A2 both have middling vulnerability scores, but have much higher average conflict scores. Group A1, in particular, has a very high concentration of conflict incidents and fatalities, in addition to having the second-highest vulnerability scores of the groups. These 54 townships (containing about 21% of the population) are clear priorities for humanitarian action. 
...
acled %>% 
  ...
  pander(caption = "Conflict events with and without village", style = "grid")
