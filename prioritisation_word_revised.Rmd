...
acled %>% 
  ...
  pander(caption = "Increase in conflict events and fatalities compared to previous decade")
...
fs_pin %>%  
  ...
  pander(caption = "Changes in conflict patterns between 2015 and 2021, by vulnerability band")
...
fs_pin %>%   
  ...
  pander(caption = "Summary statistics by prioritisation group")
...
survey %>% 
  ...
  pander(caption = "Where are the highest proportions of persons in priority groups?")
...
survey %>% 
  ...
  rename(`%_Priority` = pc,
         ...
         Shocks_Conflict = shocks_conflict, 
         Shocks_Lost_Work = shocks_lostwork) %>% 
  pander(caption = "Which areas have less people in the priority group?")
...
acled %>% 
  ...
  pander(caption = "Conflict events with and without villages")
...
fsc %>% 
  ...
  pander(caption = "2022 Q1 beneficiaries and percent reached by prioritisation group")
...
fs_pin %>% 
  ...
  pander(caption = "Summary statistics by number of floods (2008-2021)")
...
ols %>% 
  ...
  head(15) %>% 
  pander(caption = "Variables ranked by percent of variance")
