...
js <- c(
  ...
  "  var caption = 'hh_size shows the population average in the %_sample column'",
...
acled %>% 
  ...
  pander(caption = "Increase in conflict events and fatalities compared to previous decade", style = "grid")
...
fs_pin %>%  
  ...
  pander(caption = "Changes in conflict patterns between 2015 and 20221, by vulnerabilty band", style = "grid")
...
fs_pin %>%  
  ...
  pander(caption = "Summary statistics by prioritisation group", style = "grid")
...
acled %>% 
  ...
  pander(caption = "Conflict events with and without villages", style = "grid")
...
fsc %>% 
  ...
  pander(caption = "2022 Q1 beneficiaries and percent reached by prioritisation group", style = "grid")
